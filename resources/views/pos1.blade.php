...
<html lang="en">
  <head>
	...
	<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css" integrity="sha384-eN5XD1JYqR6Jl1Ff5rl5WE9MXwT3Mt7L+PwRcr5MZgbVa6JQLvKZr4ep6I5C5g7D" crossorigin="anonymous">

	<script type="text/javascript" src="{{ asset('js/jquery.min.js') }}"></script>
    <script type="text/javascript">
        $(document).ready(function() {
            setInterval(function() {
                $("#temp").load("{{ url('/2/temp')}}");
                $("#hum").load("{{ url('/2/hum')}}");
                $("#co").load("{{ url('/2/co')}}");
                $("#so2").load("{{ url('/2/so2')}}");
                $("#no2").load("{{ url('/2/no2')}}");
                $("#pm25").load("{{ url('/2/pm25')}}");
            }, 1000);
        });
    </script>
  ...
  <body>
	...
	<div class="container" style="text-align: center; margin-bottom: 24px; margin-top:20px">
		...
		<h3>PLTU Banten 3 Lontar POMU - POS 1</h3>
	</div>
	<div class="container">
		<div class="row">
	...
	<script src="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/js/all.min.js" integrity="sha384-fAcsdA6XGSuAjeqXFm9bsNQwDN1Iy3PBt8uQtmr17qPACWvKjYCa1onm2jPlmgjU" crossorigin="anonymous"></script>
  </body>
</html>